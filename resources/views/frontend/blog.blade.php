...
<section id="about" class="score-section">
  <div class="container aboutus">
    <div class="row">
      <div class="col-md-12 wow fadeInLeft" data-wow-delay="300ms">
       ...
       <p class="bottom25">We help you generate high-quality online sales leads by implementing highly structured, persuasive Internet marketing campaigns.
</p>
        ...
        <div class="col-md-4 equalheight">
            <div class="course margin_top wow fadeIn" data-wow-delay="400ms" style="padding: 15px; min-height: 375px">
              <div class="image bottom25">
                <img src="{{ asset('storage/blog/'.$result->blog_image)}}" alt="Services" class="border_radius" style="width: 100%;">
              </div>
