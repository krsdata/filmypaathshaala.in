            ...
            <div class="row clearfix">
                ...
                <div class="case-block col-md-4 col-sm-6 col-xs-12">
                  <div class="inner-box">
                      <div class="image-box">
                          <div class="image">
                              <a href="#"><img src="media/images/movie-promotion.jpg" alt="" /></a>
                        ...
                        <div class="content-box">
                          <div class="content-inner">
                              <ul class="options">
                                ...
                                <div class="text">Movie Promotion</div>
                                <a href="{{url('movie-prmotion')}}" class="read-more"><span class="icon flaticon-right-arrow-1"></span> Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                      ...
                      <div class="content-box">
                          <div class="content-inner">
                              <ul class="options">
                                ...
                                <div class="text">Digital Series and Tv Serials</div>
                                <a href="cases-single.html" class="read-more"><span class="icon flaticon-right-arrow-1"></span> Read More</a>
                            </div>
                        </div>
                        <div class="image-box">
                          <div class="image">
                              <a href="#"><img src="media/images/digital-series.jpg" alt="" /></a>
                ...
                <div class="case-block col-md-4 col-sm-6 col-xs-12">
                  <div class="inner-box">
                      <div class="image-box">
                          <div class="image">
                              <a href="cases-single.html"><img src="media/images/production.jpg" alt="" /></a>
                                <div class="overlay-box">
                                    <a href="cases-single.html" class="theme-btn btn-style-one">Visit Site</a>
                                </div>
                            </div>
                        ...
                        <div class="content-box">
                          <div class="content-inner">
                              <ul class="options">
                                ...
                                <div class="text">Production houses worked with</div>
                                <a href="cases-single.html" class="read-more"><span class="icon flaticon-right-arrow-1"></span> Read More</a>
                            </div>
                        </div>
                    </div>
             ...
             <div class="row clearfix">
                ...
                <div class="case-block col-md-4 col-sm-6 col-xs-12">
                  <div class="inner-box">
                      <div class="image-box">
                          <div class="image">
                              <a href="#"><img src="media/images/segments.jpg" alt="segments" /></a>
                      ...
                      <div class="content-box">
                          <div class="content-inner">
                              <ul class="options">
                                ...
                                <div class="text">Promotion through Memes</div>
                                
                            </div>
                        </div>
                        <div class="image-box">
                          <div class="image">
                              <a href="#"><img src="media/images/memes.jpg" alt="" /></a>
                ...
                <div class="case-block col-md-4 col-sm-6 col-xs-12">
                  <div class="inner-box">
                      <div class="image-box">
                          <div class="image">
                              <a href="cases-single.html"><img src="media/images/partner.jpg" alt="partner" /></a>
                                <div class="overlay-box">
                                 </div>
                            </div>
                        </div>
                        <div class="content-box">
                          <div class="content-inner">
                              <ul class="options">
                                ...
                                <div class="text">Our Digital Partner</div>
