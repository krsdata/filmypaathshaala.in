          ...
          <div class="auto-container">
              <div class="clearfix">
                    ...
                    <div class="top-right clearfix">
                      <ul class="clearfix">
                          <li><a href="{{url('/ppt.pdf')}}" target="_blank"><span class="icon flaticon-planet-earth"></span>Download  PPT</a></li>
          ...
          <div class="auto-container">
              <div class="outer-container clearfix">
                    ...
                    <div class="nav-outer clearfix">
                            ...
                            <div class="navbar-collapse collapse clearfix">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">About Us</a>
                                      <ul>
                                            <li><a href="{{url('about')}}">About Our Company</a></li>
                                    ...
                                    <li><a href="http://filmypaathshaala.com" target="_blank">Blog</a>
                        ...
                        <!--Outer Box-->
                        <div class="outer-box">
                            <a href="{{url('contact')}}" class="theme-btn btn-style-one"> <span class="icon flaticon-right-arrow-1"></span> Get a Quote</a>
                        </div>
