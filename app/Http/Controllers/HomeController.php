...
/**
    ...
    { 
        ...
        return view('frontend.about',compact('title','tagLine','meta1','meta2'));
    }  

    public function home(Request $request)
    {
        $title = "Filmypaathshaala";
        $tagLine = "Digital Marketing Aganecy ";
        ...
        return view('frontend.home',compact('title','tagLine','meta1','meta2'));
    }
    ...
    public function services()
    {
        ...
        return view('frontend.service',compact('service','jsUrl','title','tagLine','meta1','meta2'));
    }
    ...
    public function payment(Request $request)
    {
        ...
        $request->session()->forget('amount');
        return view('frontend.payment', compact('bankAccount','title','tagLine'));
    }
    ...
    public function pricing(Request $request)
    {
        ...
        return view('frontend.pricing',compact('pricing','title','tagLine'));
    }
    ...
    public function package()
    {
        $title = "Package";
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.package',compact('title','tagLine'));
    }
    ...
    public function privacypolicy()
    {
        ...
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.privacypolicy',compact('title','tagLine'));
    } 
     /*----------*/
    public function faq()
    {
        ...
        $title = "FAQ";
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.faq',compact('title','tagLine','faq')); 
    }
    ...
    {   
        ...
        $title = "Contact";
        $tagLine = "Free Intraday Equity and Commodity Tips by Hybrid Research";
        ...
        return view('frontend.contact',compact('title','tagLine','contact'));   
    } 
    public function tNc()
    {
        $title = "Terms & Condition";
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.tNc',compact('title','tagLine'));
    }
    ...
    public function career(Request $request, Career $career)
    {
        ...
        return view('frontend.career',compact('title','tagLine','career'));
    }

    public function blog(Blogs $blog,$id=null, $name=null)
    {
        $title = "Reports";
        $tagLine = "We offer the Digital marketing services";
        ...
        if($blogDetails){
            return view('frontend.blogDetail',compact('blogDetails','jsUrl','title','tagLine')); 
        }

        return view('frontend.blog',compact('blogs','jsUrl','title','tagLine'));
    ...
    public function riskTolrance()
    {
        $title = "Risk Tolrance";
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.riskTolrance',compact('title','tagLine'));
    }
    
    public function riskProfiling()
    {
        $title = "Risk Profiling";
        $tagLine = "Hybrid Research Investment Advisory";
        ...
        return view('frontend.riskProfiling',compact('title','tagLine'));
    }
    ...
    public function kyc(Request $request, Kyc $kyc)
    {
        $title = "Kyc";
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.kyc',compact('title','tagLine','kyc'));
    }
    ...
    public function discloser()
    {
        $title = "Discloser";
        $tagLine = "We offer the most complete advisory services in the country";
        return view('frontend.discloser',compact('title','tagLine'));
    }
    ...
    public function page(Request $request, $name=null)
    {
        ...
        return view('frontend.page',compact('title','tagLine','page'));   
    ...
    {
        $title       = "Hybrid Research Investment Advisory";
        $tagLine     = "We offer the most complete advisory services in the country";
       ...
       return view('frontend.risk-profiling',compact('title','tagLine','kyc'));
    }
    ...
    public function riskTolranceForm(Request $request, Kyc $kyc)
    {
       ...
       return view('frontend.risk-tolrance',compact('title','tagLine','kyc'));
    }
    ...
    public function freeTrialForm(Request $request, FreeTrial $freeTrial)
    {
        ...
        return view('frontend.freeTrialForm',compact('title','tagLine','freeTrial','meta1','meta2'));
    ...
    public function lifeAtResearchInfotech(Request $request)
    {
      ...
      // dd(file_exists(storage_path('gallery/gallery6.jpg')));
        return view('frontend.lifeAtResearchInfotech',compact('title','tagLine','gallery'));
    ...
    public function paymentResponse(Request $request, $status=null)
    {
        ...
        return view('frontend.paymentStatus',compact('title','tagLine','msg','response'));
    }
    ...
    public function paymentStatus(Request $request, $status=null)
    {
        ...
        return view('frontend.paymentStatus',compact('title','tagLine','msg','params'));
    }
    ...
    public function paymentConfirm(Request $request){
        ...
        return view('frontend.confirmPayment',compact('title','tagLine','btn')); 
    ...
    public function checkOutEbs(Request $request, $serviceName=null){
        ...
        return view('frontend.ebs',compact('defaultAmount','title','tagLine','jsUrl1','jsUrl2','serviceName','amount','payment','merchant_id','order_id','accountId'));
    }
    ...
    public function checkout(Request $request, $serviceName=null)
    {
       ...
       // dd($encrypted_data,$working_key);
        ...
        return view('frontend.paypal',compact('defaultAmount','title','tagLine','jsUrl1','jsUrl2','serviceName','amount','payment','merchant_id','order_id'));
    }
